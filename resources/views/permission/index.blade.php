...
<div class="col-xl-4 mt-4 mb-4">
    <a href="#permission" type="button"  class="btn btn-primary waves-effect waves-light" data-animation="fadein" data-plugin="custommodal"
        data-overlaySpeed="200" data-overlayColor="#36404a">Nouvelle permission</a>
</div><!-- end col -->
</div>
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-box">
                <div class="dropdown pull-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item"><i class="fa fa-print"></i> Imprimer</a>
                        <!-- item-->
                    
                    </div>
                </div>
                <h4 class="m-t-0 header-title">Les permissions</h4>
                ...
                <table  class="table">
                    ...
                    <tr>
                        ...
                        <td>
                           <div class="d-flex">
		                    <a href="{{route('Permission.edit', $permission->id)}}" class="btn btn-sm btn-primary btn-rounded waves-effect waves-light m-b-5 mr-2"><i class="fa fa-edit"></i></a>
...
<!-- Modal create -->
<div id="permission" class="modal-demo">
<button type="button" class="close" onclick="Custombox.close();">
    <span>&times;</span><span class="sr-only">Fermer</span>
</button>
<div class="m-t-40 card-box">
    <div class="text-center">
        <img src="{{asset('assets/images/agetic.png')}}" width="100" height="70">
        <h4 class=" font-bold m-b-0">Nouvelle permission</h4>
    </div>
    <div class="p-20">
        <form class="form-horizontal m-t-20" action="{{route('Permission.store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="form-group ">
                <div class="col-xs-12">
                    <input class="form-control" type="text" name="name" required="" placeholder="titre">
                </div>
            </div>
