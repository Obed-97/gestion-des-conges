...
<div class="m-t-40 card-box">
    <div class="text-center">
        <img src="{{asset('assets/images/agetic.png')}}" width="100" height="70">
        <h4 class=" font-bold m-b-0">Modifier le service</h4>
    </div>
    <div class="p-20">
        <form class="form-horizontal m-t-20" action="{{route('Service.update', $service->id)}}" method="POST" enctype="multipart/form-data">
        	@csrf
            {{method_field('PUT')}}
			<div class="form-group ">
				<div class="col-xs-12">
					<input class="form-control" type="text" name="ordre_service" value="{{$service->ordre_service}}" required="" placeholder="Ordre du service">
				</div>
			</div>

			<div class="form-group ">
				<div class="col-xs-12">
					<textarea class="form-control" name="lib_service"  required="" placeholder="Libelle">{{$service->lib_service}}</textarea> 
				</div>
			</div>
