...
<div class="col-xl-4 mt-4 mb-4">
    <a href="#create_service" type="button"  class="btn btn-primary waves-effect waves-light" data-animation="fadein" data-plugin="custommodal"
        data-overlaySpeed="200" data-overlayColor="#36404a">Nouveau service</a>
</div><!-- end col -->
</div>
@endcan
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card card-draggable m-b-20">
            <img class="card-img-top " width="150" height="300" src="/assets/images/{{$service->image}}" >
            <div class="card-body">
                <h4 class="card-title">{{$service->ordre_service}}</h4>
                <p class="card-text">{{$service->lib_service}}</p>
            </div>
            @can('agir')
            <div class=" card-body d-flex">
             <a href="{{route('Service.edit', $service->id)}}" type="button" class="btn btn-sm btn-primary btn-rounded waves-effect waves-light m-b-5 mr-2"><i class="fa fa-edit"></i></a>
...
<!-- Modal create -->
<div id="create_service" class="modal-demo">
<button type="button" class="close" onclick="Custombox.close();">
    <span>&times;</span><span class="sr-only">Fermer</span>
</button>
 <div class="text-center">
        <img src="{{asset('assets/images/agetic.png')}}" width="100" height="70">
        <h4 class=" font-bold m-b-0">Nouveau service</h4>
    </div>
    <div class="p-20">
        <form class="form-horizontal m-t-20" action="{{route('Service.store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="form-group ">
                <div class="col-xs-12">
                    <input class="form-control" type="text" name="ordre_service" required="" placeholder="Ordre du service">
                </div>
            </div>

            <div class="form-group  mb-5">
                <div class="col-xs-12">
                    <textarea class="form-control" name="lib_service" required="" placeholder="Libelle"></textarea> 
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-secondary waves-effect waves-light m-l-10" onclick="Custombox.close();">Annuler</button>
                </div>
            </div>
