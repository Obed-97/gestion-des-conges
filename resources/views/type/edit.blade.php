...
<div class="m-t-40 card-box">
    <div class="text-center">
        <img src="{{asset('assets/images/agetic.png')}}" width="100" height="70">
        <h4 class=" font-bold m-b-0">Modifier le type</h4>
    </div>
    <div class="p-20">
        <form class="form-horizontal m-t-20" action="{{route('Type.update', $type->id)}}" method="POST" enctype="multipart/form-data">
        	@csrf
            {{method_field('PUT')}}
			<div class="form-group ">
				<div class="col-xs-12">
					<input class="form-control" type="text" name="lib_type_conge" value="{{$type->lib_type_conge}}" required="" placeholder="Libelle">
				</div>
			</div>
			<div class="form-group ">
				<div class="col-xs-12">
					<input class="form-control" type="integer" name="nbjours" value="{{$type->nbjours}}" required="" placeholder="Nombre de jours">
				</div>
			</div>
