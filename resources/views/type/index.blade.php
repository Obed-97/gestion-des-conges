...
<div class="col-xl-4 mt-4 mb-4">
    <a href="#create" type="button"  class="btn btn-primary waves-effect waves-light" data-animation="fadein" data-plugin="custommodal"
        data-overlaySpeed="200" data-overlayColor="#36404a">Nouveau type</a>
</div><!-- end col -->
</div>
@endcan
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card m-b-20 card-inverse text-white" style="background-color: #333; border-color: #333;">
            <div class="card-body">
                <h4 class="card-title">{{$type->lib_type_conge}}</h4>
                <h4 class="card-text mb-4">{{$type->nbjours}} jours</h4>
                @can('agir')
                <div class="d-flex">
                    <a href="{{route('Type.edit', $type->id)}}"  type="button" class="btn btn-sm btn-primary btn-rounded waves-effect waves-light m-b-5 mr-2" ><i class="fa fa-edit"></i></a>
...
<div class="text-center">
    <img src="{{asset('assets/images/agetic.png')}}" width="100" height="70">
    <h4 class=" font-bold m-b-0">Nouveau type de congé</h4>
</div>
<div class="p-20">
    <form class="form-horizontal m-t-20" action="{{route('Type.store')}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="form-group ">
            <div class="col-xs-12">
                <input class="form-control" type="text" name="lib_type_conge" required="" placeholder="Libelle">
            </div>
        </div>
        <div class="form-group mb-5 ">
            <div class="col-xs-12">
                <input class="form-control" type="integer" name="nbjours" required="" placeholder="Nombre de jours">
            </div>
        </div>
