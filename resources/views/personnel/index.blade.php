...
<div class="row">
    ...
    <div class="col-xl-4">
        <div class="text-center card-box">
            <div>
                <img src="/assets/images/users/{{$personnel->photo}}" class="rounded-circle thumb-xl img-thumbnail m-b-10" alt="profile-image">

                <div class="text-left">
                    <p class="text-muted font-13"><strong>Nom complet :</strong> <span class="m-l-15">{{$personnel->prenom}} {{$personnel->nom}}</span></p>

                     <p class="text-muted font-13"><strong>Poste :</strong> <span class="m-l-15">{{$personnel->role['name']}}</span></p>

                    <p class="text-muted font-13"><strong>Téléphone :</strong><span class="m-l-15">{{$personnel->tel}}</span></p>

                    <p class="text-muted font-13"><strong>Email :</strong> <span class="m-l-15">{{$personnel->email}}</span></p>

                    <p class="text-muted font-13"><strong>Adresse :</strong> <span class="m-l-15">{{$personnel->adresse}}</span></p>
                </div>
