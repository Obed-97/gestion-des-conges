...
<div class="m-t-40 card-box">
    <div class="text-center">
        <img src="{{asset('assets/images/agetic.png')}}" width="100" height="70">
        <h4 class=" font-bold m-b-0">Nouvelle affectation</h4>
    </div>
    <div class="p-20">
        <form class="form-horizontal m-t-20" action="{{route('Affectation.store')}}" method="POST" enctype="multipart/form-data">
        	{{csrf_field()}}
			<div class="form-group ">
				<div class="col-xs-12">
					<select id="user_id" name="user_id" class="form-control" required autocomplete="user_id" autofocus  required="">
                            <option value="" selected>Choisir un personnel</option>
			...
			<div class="form-group ">
				    ...
				    <input type="date" name="date_affect" class="form-control" required autocomplete="date_affect" autofocus  required="">                    
			</div>
