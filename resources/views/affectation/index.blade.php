...
<div class="col-xl-4 mt-4 mb-4">
    <a href="{{route('Affectation.create')}}" type="button" class="btn btn-primary waves-effect waves-light">Nouvelle affectation</a>
</div><!-- end col -->
</div>
@endcan
<div class="row">
<div class="col-12">
    ...
    <div class="card-box">
        ...
        <table  class="table  ">
            ...
            <tr>
                <td>
                    <img src="/assets/images/users/{{$affectation->user['photo']}}" class="rounded-circle" width="60" height="60"  alt="">
                </td>
                <td>{{$affectation->user['prenom']}} {{$affectation->user['nom']}}</td>
                <td>{{$affectation->service['ordre_service']}}</td>
                <td>{{date('d M Y', strtotime($affectation->date_affect));}}</td>
                @can('agir')
                <td class="d-flex">
                    <a type="button" href="{{route('Affectation.edit', $affectation->id )}}" class="btn btn-sm btn-secondary btn-rounded waves-effect waves-light m-b-5 mr-2"><i class="fa fa-edit"></i></i></a>
